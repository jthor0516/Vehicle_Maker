    ...
    inquirer
      ...
      .then((answers) => {
        if (this.selectedVehicleVin === answers.vehicleToTow.vin) {
          console.log('Truck cannot tow itself, please choose a different vehicle');
          this.performActions();
        } else {
          ...
          for (let i = 0; i < this.vehicles.length; i++) {
            if (this.vehicles[i].vin === this.selectedVehicleVin) {
              if (this.vehicles[i] instanceof Truck) {
                ...
                console.log('This vehicle is unable to tow, please select a truck next time.');

              }
            }
          }
        } else if (answers.action === 'Perform a wheelie (motorbike only)') {
          ...
          for (let i = 0; i < this.vehicles.length; i++) {
            if (this.vehicles[i].vin === this.selectedVehicleVin) {
              if (this.vehicles[i] instanceof Motorbike) {
                ...
                console.log('This vehicle is unable to perform a wheelie, please select a motorbike next time.')
              }
            }
          }
